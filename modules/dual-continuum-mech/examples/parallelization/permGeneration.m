...
%%
for i=1:nParallel
    filename = ['perm_', num2str(i), '.mat'];
    perm_f_ = perm_m_tot(:, (i-1)*nCase/nParallel+1:i*nCase/nParallel);
    perm_m_ = perm_f_tot(:, (i-1)*nCase/nParallel+1:i*nCase/nParallel);
    EM_ = EM_tot(:, (i-1)*nCase/nParallel+1:i*nCase/nParallel);
    EF_ = EF_tot(:, (i-1)*nCase/nParallel+1:i*nCase/nParallel);
    save(filename, 'perm_f_', 'perm_m_', 'EM_', 'EF_', 'i_index', 'j_index', 'x_centroid', 'y_centroid', 'nCase', 'nParallel');
end
% 
% figure
