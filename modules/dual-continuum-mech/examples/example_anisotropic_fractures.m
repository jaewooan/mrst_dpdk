...
figure
for i=1:10
    X_(i, :) =  G.cells.centroids(10*(i-1)+1:10*i,1)';
    Y_(i, :) =  G.cells.centroids(10*(i-1)+1:10*i,2)';
    R_(i,:) = p_f(10*(i-1)+1:10*i,60);
end
pcolor(X_, Y_, R_);
set(gca,'YDir','normal') 
colorbar
...
figure
for i=1:11
    X__(i, :) =  G.nodes.coords(11*(i-1)+1:11*i,1)';
    Y__(i, :) =  G.nodes.coords(11*(i-1)+1:11*i,2)';
    R__(i,:) = u(11*2*(i-1)+1:2:11*2*(i-1)+22,60);
end
pcolor(X__, Y__, R__);
set(gca,'YDir','normal') 
colorbar
...
for i=1:11
    X__(i, :) =  G.nodes.coords(11*(i-1)+1:11*i,1)';
    Y__(i, :) =  G.nodes.coords(11*(i-1)+1:11*i,2)';
    R__(i, :) = u(11*2*(i-1)+2:2:11*2*(i-1)+23,60);
end
pcolor(X__, Y__, R__);
set(gca,'YDir','normal') 
colorbar
